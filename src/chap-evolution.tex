...
być lepiej zintegrowany z~\acc{DMA} \acc{API} jądra, będącym
standardowym interfejsem, który sterowniki mogą wykorzystywać, by
alokować bufory \acc{DMA}.  Dlatego w~wersji dziesiątej \acc{CMA},
...
W~tym momencie mechanizm \acc{CMA} był dostatecznie stabilny
i~niezawodny, aby Andrew Morton dołączył go do swojego drzewa
\code{-mm}, które następnie zostało połączone z~drzewem Linusa
Torvaldsa. \TODO{Zrobić coś z~„drzewem”?}
