...
migracji stron opisanego pokrótce w~podrozdziale
...
zaimplementowaniem CMA, Linux nie posiadał mechanizmu, który
...
musiałem zaimplementować specjalnie na potrzeby CMA i~jest ona opisana
