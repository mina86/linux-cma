...
w~trakcie działania funkcji \lstinline|alloc_contig_range()|.
...
funkcja \lstinline|alloc_contig_range()|, aby dany obszar zaalokować
...
powodu, funkcja \lstinline|dma_alloc_from_contiguous()| działa w~pętli
