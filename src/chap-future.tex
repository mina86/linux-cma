...
w~znacznym stopniu poprawić doświadczenie użytkownika\TODO{kalka
  z~ang.}, ale z~drugiej strony większe zużycie pamięci może spowolnić
resztę środowiska.  Dzięki zastosowaniu \code|POSIX_FADV_VOLATILE|
jądro może zdecydować, aby usunąć dane z~pamięci podręcznej
przeglądarki.  Oczywiście z~puntu widzenia \acc{CMA}, możliwość
...
mechanizm \acc{CMA} będzie się dalej rozwijał w~rosnącym tempie.
