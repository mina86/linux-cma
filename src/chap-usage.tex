...
\code|dma_alloc_coherent()| i~\code|dma_free_coherent()|.
...
procesor\footnote{W~różnych architekturach efekt ten jest uzyskiwany
  ...
  bufory alokowane przy pomocy \code|dma_alloc_coherent()| nie
  podlegają cacheowaniu \TODO{przetłumaczyć} po stronie procesora.}.  Wydruk
...
% line manually...
% XXX TODO: add some indicator that the line has been broken.
