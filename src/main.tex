...
\usepackage[backend=bibtex,sorting=none,style=numeric-comp,
...
\def\code{\lstinline[basicstyle=\itshape,columns=fullflexible]}
...
#1}{\small\bfseries \ #1}}
\renewcommand*{\sectionmark}[1]{\markboth{\scshape\small\bfseries\ifHeadingNumbered\thesection.\ \fi
#1}{\small\bfseries\ifHeadingNumbered\thesection.\ \fi #1}}
...
\makeatletter
\def\ang@star{\textit}
\newcommand*{\ang@nostar}[1]{ang.\ \ang@star{#1}}
\newcommand*{\ang}{\@ifstar\ang@star\ang@nostar}
\makeatother
\newcommand{\acc}[1]{\textsc{\lowercase{#1}}}

% \operatorname gave error thus \mathrm
\newcommand{\BigO}[1]{\ensuremath{\mathrm{\mathcal{O}}\left(#1\right)}}
