...
\lstset{
  ...
  stringstyle=\color{GoogleRed}\ttfamily
}
\lstdefinelanguage{diff}{
  morecomment=[f][\color{GoogleBlue}]{@@},     % group identifier
  morecomment=[f][\color{GoogleRed}]-,         % deleted lines
  morecomment=[f][\color{GoogleGreen}]+,       % added lines
