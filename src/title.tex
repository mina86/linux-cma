\begin{titlepage}
    ...
    {\itshape Wiele podzespołów komputera, a~szczególnie
      ...
      dostępu do pamięci (\ang{Direct Memory Access}, DMA) są
      ...
      \ang{Contiguous Memory Allocator} (CMA), który rozwiązuje ten
    ...
    {\itshape Many computer components, especially in a~so called
      ...
      Memory Access (DMA) is limited to sequential transfers only.
      ...
      This work describes Contiguous Memory Allocator (CMA) -- an
